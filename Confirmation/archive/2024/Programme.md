---
title: Confirmation Programme 2024 (Archive)
description: Archived calendar, sessions and homework from the 2024 Confirmation programme
---

> This page is an archive of the 2024 programme. For the current programme, visit [Confirmation 2026](../../2026Programme.md).

Go to the [archived 2024 resources page](./Resources.md) for the resources used that year, or visit the [current Confirmation resources](../../ResourcesforConfirmation.md).

**Reminder**: Choose a Saint, a Confirmation name, and a sponsor. A list of suggested saints is available in the booklet or in the [archived resources page](./Resources.md).
...
[Back to current Confirmation resources](../../ResourcesforConfirmation.md)
